...
Fraction(int numerator, int denominator) { ++instanceCount;
...
@Override
public boolean equals(Object obj) { if ((obj instanceof Fraction) == false) return false;
Fraction f = (Fraction)obj;
return this.numerator == f.numerator && this.denominator == f.denominator;
}
public static int getInstancenCount() { return instanceCount;
}
